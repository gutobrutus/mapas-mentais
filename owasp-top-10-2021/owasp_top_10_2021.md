...
- Ela está presente em vários locais através de denominação de capítulos. Por exemplo, capítulo OWASP Brasília.
...
#### Descrição
- Implementação falha/inadequada de controle de acesso, durante o desenvolvimento.
- Alta ocorrência em APIs.
...
- Os componentes incluem: SGBD, OS, Webserver, libs e dependências.
...
#### Prevenção
- Utilizar alguma ferramenta de SAST (Ex.: Sonar).
